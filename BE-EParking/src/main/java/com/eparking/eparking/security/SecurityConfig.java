...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers(GET, "/reservation/getReservationDetail").hasAnyAuthority("ROLE_CUSTOMER");
        http.authorizeRequests().antMatchers(PUT, "/reservation/updateReservationStatus").hasAnyAuthority("ROLE_CUSTOMER");
        http.authorizeRequests().antMatchers(GET, "/car/getListCarOfUser").hasAnyAuthority("ROLE_CUSTOMER");
        http.authorizeRequests().antMatchers(POST, "/car/addCar").hasAnyAuthority("ROLE_CUSTOMER");
